...
process MERGE_CLUSTER_STATS {
  ...
  script:
  """
    echo -e "${sample}\tcluster_id\tcluster_written\treads_found\treads_found_fwd\treads_found_rev\treads_written_fwd\treads_written_rev\treads_skipped_fwd\treads_skipped_rev" \
    > ${cluster_stats_file}
