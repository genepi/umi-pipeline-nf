...
def parse_cluster_stat(cluster_stat_file, sample):
...
def load_and_update_summary(cluster_stats_parsed, sample, current_summary, output_tsv):
...
if __name__ == "__main__":
    args = parse_args()
    cluster_stats_parsed, sample = parse_cluster_stat(args.cluster_stat, args.sample)
    summary = load_and_update_summary(cluster_stats_parsed, args.sample, args.current_summary, args.output_tsv)
